...
function gestionarXml(dadesXml){
 ...
 var opcionesSelect1 = [];
 var nopt1 = xmlDoc.getElementById("profe_002").getElementsByTagName('option').length;
  for (i = 0; i < nopt; i++) { 
    opcionesSelect1[i] = xmlDoc.getElementById("profe_002").getElementsByTagName('option')[i].innerHTML;
 }
